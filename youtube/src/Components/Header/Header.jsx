...
const Header = () => {
  ...
  return (
    <>
          ...
          <div className="header_box py-1 pr-7 flex items-center justify-between">
            <div className="header_items_navLeft flex items-center gap-12">
              <div className="logo flex gap-7 items-center">
                <div className="header_items_navLeft_burger hover:bg-zinc-300 ..., cursor-pointer rounded-full p-3">
      ...
      <div className="header_ping">
        <div className="flex items-center justify-between header_close">
          <img src={logo} alt="" />
          <div className="flex items-center gap-3">
            <AiOutlineSearch className="search_close" />
            <img src={me} alt="" />
          </div>
        </div>
      </div>
